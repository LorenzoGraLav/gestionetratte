...
public class AirbusDTO {
	...
	public AirbusDTO(String codice, String descrizione, LocalDate dataInizioServizio, Integer numeroPasseggeri) {
		super();
		this.codice = codice;
		this.descrizione = descrizione;
		this.dataInizioServizio = dataInizioServizio;
	...
	public AirbusDTO(String codice, String descrizione, Integer numeroPasseggeri) {
		super();
		this.codice = codice;
		this.descrizione = descrizione;
		this.numeroPasseggeri = numeroPasseggeri;
